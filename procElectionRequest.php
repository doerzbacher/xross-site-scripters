	...
	<?php
		...
		if(is_array($electionContent))
		{
			if(!is_null($electionContent["title"]))
			{
				...
				echo "<form action='procBallot.php' method='post'><div class='row'><div class='col-md-4 col-md-offset-4'><label for='userID'>User ID</label><input type='text' class='form-control' id='userID' readonly></div></div><br>";
